...
class QuizWinBio extends StatefulWidget {
//  QuizWinBio({ required this.text ,   required this.a ,   required this.b ,   required this.c ,   required this.d ,   required this.ascore ,   required this.bscore ,   required this.cscore ,   required this.dscore ,   required this.ap1 ,   required this.ap2 ,   required this.ap3 ,   required this.bp1 ,   required this.bp2 ,   required this.bp3 ,   required this.cp1,   required this.cp2,   required this.cp3,   required this.dp1,   required this.dp2,   required this.dp3,   required this.anext,   required this.bnext,   required this.cnext,   required this.dnext});
// QuizWinBio({ required this.text ,   required this.a ,   required this.b ,   required this.c ,   required this.d ,   required this.ascore ,   required this.bscore ,   required this.cscore ,   required this.dscore ,   required this.ap1 ,   required this.ap2 ,   required this.ap3 ,   required this.bp1 ,   required this.bp2 ,   required this.bp3 ,   required this.cp1,   required this.cp2,   required this.cp3,   required this.dp1,   required this.dp2,   required this.dp3,   required this.anext,   required this.bnext,   required this.cnext,   required this.dnext});
  List<int>done;
  QuizWinBio({required this.done});
  @override
  //State<QuizWinBio> createState() => _QuizWinBioState(text:text,  a:a,  b:b,  c:c,  d:d,  ascore:ascore,  bscore:bscore,  cscore:cscore,  dscore:dscore,  ap1:ap1,  ap2:ap2,  ap3:ap3,  bp1:bp1,  bp2:bp2,  bp3:bp3,  cp1:cp1,  cp2:cp2,  cp3:cp3,  dp1:dp1,  dp2:dp2,  dp3:dp3,  anext:anext,  bnext:bnext,  cnext:cnext,  dnext:dnext);
  State<QuizWinBio> createState() => _QuizWinBioState(
    done: done,
    text:bank[0]["text"],
...
class _QuizWinBioState extends State<QuizWinBio> {
